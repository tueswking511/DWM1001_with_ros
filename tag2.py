...
MQTT_Server_IP="192.168.139.132"
...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("dwm/node/d43a/uplink/location")
...
def on_message(client, userdata, msg):
    ...
    hex_string = driver.find_element_by_id('node-54330-nodeUplink').get_attribute('value')[:-4]
    ...
    if type(data["position"]["x"]) == float:
        ...
        marker_publisher = rospy.Publisher('visualization_marker/Tag2', Marker, queue_size=128)
...
driver.find_element_by_id('node-54330-name').click()
...
pub = rospy.Publisher('dwm/tag/Tag2/Pose', PointStamped, queue_size=128)
